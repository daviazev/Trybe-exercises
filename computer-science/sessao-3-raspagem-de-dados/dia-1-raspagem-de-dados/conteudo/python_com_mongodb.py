...
# Quando um documento é inserido, um _id único é gerado e retornado. Também podemos fazer inserção 
# de múltiplos documentos de uma vez da seguinte forma:
...
# O nosso cliente é um gerenciador de contexto (with), logo podemos utilizá-lo como tal, evitando 
# problemas com o fechamento da conexão com o banco de dados:
