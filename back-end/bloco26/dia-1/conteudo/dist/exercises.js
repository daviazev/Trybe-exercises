...
exports.circulo = exports.trapezio = exports.losango = exports.triangleCheck = exports.getPolygonPerimeter = exports.getTriangleArea = exports.getRectangleArea = exports.getSquareArea = void 0;
...
function losango(sideD, sided) {
    return (sideD * sided) / 2;
}
exports.losango = losango;
function trapezio(sideB, sideb, height) {
