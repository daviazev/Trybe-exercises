...
-- Também podemos calcular a diferença em dias entre duas datas usando o DATEDIFF e a 
-- diferença de tempo entre dois horários usando o TIMEDIFF. Em ambos os casos, 
-- o segundo valor é subtraído do primeiro para calcular o resultado.
...
-- Outro ponto interessante é que também podemos usar CURRENT_DATE() e NOW() em conjunto com 
-- os comandos de manipulação de datas e tempo para encontrar resultados dinâmicos da seguinte maneira:
