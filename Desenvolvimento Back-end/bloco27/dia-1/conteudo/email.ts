/*
    ...
    Primeiramente vamos criar a classe Email. Ela será responsável por guardar os 
    dados do e-mail na forma de atributos. Além disso, Email possui alguns métodos, 
    sendo o mais importante deles o get content, que retorna uma string formatada com todo 
    o corpo do e-mail.
*/
...
class Email {
  ...
  get content(): string {
    return `From ${this._from} to ${this._to} ${this.subject} ${this._message}`;
  }
}

/*
    É interessante observar o uso do encapsulamento na manipulação dos atributos, 
    com destaque para a validação do comprimento do campo assunto.

    Em seguida vem a criação da classe MailList, que representa uma lista de e-mails. 
    Esta é uma classe muito interessante, pois nos permite manter todos os e-mails 
    correlacionados em um único objeto. Além disso, nos permite filtrar os e-mails da 
    lista de forma simplificada, utilizando abstração.
*/
