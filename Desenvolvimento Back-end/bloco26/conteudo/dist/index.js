...
console.log(`1 -  área de um losango que tem D = 32cm e d = 18cm: ${Ex.losango(32, 18)} `);
console.log(`1 -  área de um losango que tem D = 200cm e d = 50cm: ${Ex.losango(200, 50)} `);
console.log(`1 -  área de um losango que tem D = 75cm e d = 25cm: ${Ex.losango(75, 25)} `);
console.log('----------------------------------------------------------------');
console.log(`2 - a área de um trapézio que tem B = 100cm, b = 70cm e altura = 50cm: ${Ex.trapezio(100, 70, 50)}`);
console.log(`2 - a área de um trapézio que tem B = 75cm, b = 50cm e altura = 35cm: ${Ex.trapezio(75, 50, 35)}`);
console.log(`2 - a área de um trapézio que tem B = 150cm, b = 120cm e altura = 80cm: ${Ex.trapezio(150, 120, 80)}`);
console.log('----------------------------------------------------------------');
...
console.log(`3 - a área de um círculo de raio igual 12.5cm: ${Ex.circulo(12.5)}`);
